...
AddEventHandler('textsent', function(tPID, names2)
	TriggerEvent('chat:addMessage', {
        template = '<div class="chat-message emergency"><i class="fa fa-gavel"></i> <strong>{0}</strong>',
        args = {'Pesan Terkirim Kepada : ' .. names2 .. ' | ID : ' .. tPID }
    })
end)
...
AddEventHandler('textmsg', function(source, textmsg, names2, names3 )
	TriggerEvent('chat:addMessage', {
        template = '<div class="chat-message emergency"><i class="fa fa-gavel"></i> <strong>{0}</strong>',
        args = {'TEAM URBAN | ' .. names3 .. ' : ' .. textmsg }
    })
end)
