	...
	
  {
...

	{
		...
		components = {
            ...
            { name = 'clip_incendiary', label = _U('component_clip_incendiary'), hash = GetHashKey('COMPONENT_HEAVYSNIPER_MK2_CLIP_INCENDIARY') },
            { name = 'scope', label = _U('component_scope'), hash = GetHashKey('COMPONENT_AT_SCOPE_LARGE_MK2') },
			{ name = 'scope_advanced', label = _U('component_scope_advanced'), hash = GetHashKey('COMPONENT_AT_SCOPE_MAX') },
			{ name = 'scope_night_vision', label = _U('component_scope_night_vision'), hash = GetHashKey('COMPONENT_AT_SCOPE_NV') },
