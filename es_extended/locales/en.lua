Locales['en'] = {
  ...
  ['gave_item'] = 'Kamu memberi %sx %s ke %s',
  ['received_item'] = 'Kamu menerima %sx %s dari %s',
  ['gave_weapon'] = 'Kamu memberi 1x %s ke %s.',
  ['gave_weapon_ammo'] = 'Kamu memberi 1x %s dengan %sx peluru ke %s.',
  ['gave_weapon_hasalready'] = '%s sudah punya %s',
  ['received_weapon'] = 'Kamu menerima 1x %s dari %s.',
  ['received_weapon_ammo'] = 'Kamu menerima 1x %s dengan %sx peluru dari %s.',
  ...
  ['gave_money'] = 'Kamu memberi uang $%s ke %s',
  ['received_money'] = 'Kamu menerima uang $%s dari %s',
  ['gave_account_money'] = 'you gave ~g~$%s (%s) to %s',
  ['received_account_money'] = 'you received ~g~$%s (%s) from %s',
  ...
  -- Salary related
  ['received_salary'] = 'Anda menerima gaji sebesar: $%s',
  ...
  ['money_set'] = 'someone highly ranked just set ~g~$%s (%s) for you!',
