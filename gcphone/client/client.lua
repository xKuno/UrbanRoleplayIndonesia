...
function ShowNoPhoneWarning () 
  ...
  exports['mythic_notify']:SendAlert('inform', 'You dont have a phone')
end
...
AddEventHandler("gcPhone:receiveMessage", function(message)
  ...
  if message.owner == 0 then
    ...
    TriggerEvent('notification', text, 1)
...
AddEventHandler("gcPhone:waitingCall", function(infoCall, initiator)
  ...
  if initiator == true then
    ...
    TriggerEvent('notification', 'Berdering..', 1)
  end
end)
...
RegisterNUICallback('takePhoto', function(data, cb)
  ...
  elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
      exports['screenshot-basic']:requestScreenshotUpload("https://discord.com/api/webhooks/820978860766003251/GOYHuYdD301eChxxRIukEbxipmTpeHDzEKn22UhxfEO95A_IUv1OmNeWgljCiNA45i5h", data.field, function(data)
...
RegisterCommand("hape", function(source, args, rawCommand)
