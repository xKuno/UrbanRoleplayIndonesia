...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
			...
			TriggerServerEvent("esx:apartmentputitem",ESX.GetPlayerData().identifier, data.item.name, count)
        end
...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
			...
			TriggerServerEvent("esx:apartmentgetitem",ESX.GetPlayerData().identifier, data.item.name, count, tonumber(data.number))
        end
