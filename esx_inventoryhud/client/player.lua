...
AddEventHandler("esx_inventoryhud:openPlayerInventory",function(target, playerName)
	...
	if PlayerData.job and PlayerData.job.name == 'police' or PlayerData.job.name == 'ambulance' or PlayerData.job.name == 'biker' or PlayerData.job.name == 'cartel' or PlayerData.job.name == 'mafia' or PlayerData.job.name == 'gang'  then
        	targetPlayer = target
        	targetPlayerName = playerName
        	setPlayerInventoryData()
        	openPlayerInventory()
	else
		ESX.ShowNotification('Lau ngapain?. -mafinsky')
