...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        if type(data.number) == "number" and math.floor(data.number) == data.number then
			...
			TriggerServerEvent("esx:motelputitem",ESX.GetPlayerData().identifier, data.item.name, count)
        end
...
RegisterNUICallback(
    ...
    function(data, cb)
        ...
        TriggerServerEvent("lsrp-motels:getItemBed", ESX.GetPlayerData().identifier, data.item.type, data.item.name, tonumber(data.number))
			TriggerServerEvent("esx:motelgetitem",ESX.GetPlayerData().identifier, data.item.name, count, tonumber(data.number))
        end
