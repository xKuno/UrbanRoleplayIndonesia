...
RegisterCommand("mask", function()
    ...
    loadAnimDict(ad)
  	loadAnimDict(ads)
    TaskPlayAnim(players, "mp_masks@standard_car@ds@", "put_on_mask", 8.0, 1.0, -1, 49, 0, 0, 0, 0 )
    Wait(600)
    ClearPedSecondaryTask(PlayerPedId())
...
RegisterCommand("tul", function()
    TriggerEvent('smerfikubrania:koszulka')
end)

RegisterCommand("spo", function()
    TriggerEvent('smerfikubrania:spodnie')
end)

RegisterCommand("but", function()
