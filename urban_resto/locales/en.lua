Locales['en'] = {
  ...
  ['wear_citizen'] = 'Baju Warga',
  ['wear_work'] = 'Baju Dinas pedagang',
  ...
  ['only_pedagang'] = 'you can only store pedagangs.',

  ['taking_service'] = 'taking service: pedagang/Uber',
  ...
  ['must_in_pedagang'] = 'you must be in a ~y~pedagang~s~ to start the mission',
