...
AddEventHandler('nfw_wep:SmallArmor', function()
    ...
    TriggerEvent('mythic_progbar:client:progress', {
        ...
        if not status then
            ...
            exports['mythic_notify']:DoHudText('inform', 'You have put on Armor Level 1')
        end
    end)
end)
...
AddEventHandler('nfw_wep:MedArmor', function()
    ...
    TriggerEvent('mythic_progbar:client:progress', {
        ...
        if not status then
            ...
            exports['mythic_notify']:DoHudText('inform', 'You have put on Armor Level 2')
        end
    end)
end)