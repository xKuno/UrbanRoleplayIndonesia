...
function showHurt()
	...
	--exports['mythic_notify']:DoHudText('error', 'You need to seek medical attention.')
end
...
Citizen.CreateThread(function()
	while true do
		...
		elseif injuredcounter == 46000 then -- 46000
			...
			--exports['mythic_notify']:DoHudText('error', 'You need to get to a hospital now!.')
		elseif injuredcounter == 54000 then -- 54000
			...
			--exports['mythic_notify']:DoHudText('error', 'You did not get treated in time.')
...
function showNotHurt()
	...
	--exports['mythic_notify']:DoHudText('success', 'You have been treated')
end
