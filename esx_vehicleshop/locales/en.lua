Locales['en'] = {
  ...
  ['vehicle_belongs']         = 'Kendaraan Dengan Plat ~y~%s~s~ Sekarang Milik ~b~Kamu~s~',
  ...
  ['buy_vehicle_shop']        = 'Apakah Kamu Ingin Membeli %s Dengan Harga $%s?',
  ['buy_vehicle']             = 'Beli Kendaraan',
  ['car_dealer']              = 'Dealer Kendaraan',
  ['shop_awaiting_model']     = 'Sedang Memuat Kendaraan, Harap Sabar',
