...
AddEventHandler("FakeRevive", function(inputText)
        ...
        beltOn = not beltOn 
        if beltOn then 
		  TriggerEvent("pNotify:SendNotification", {text = "Seat Belt On", type = "success", timeout = 1400, layout = "centerLeft"})
		  ...
		  TriggerEvent("pNotify:SendNotification", {text = "Seat Belt Off", type = "error", timeout = 1400, layout = "centerLeft"})
