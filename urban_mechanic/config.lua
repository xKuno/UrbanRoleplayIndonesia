...
Config.NPCSpawnDistance           = 1000.0
Config.NPCNextToDistance          = 25.0
Config.NPCJobEarnings             = { min = 4000, max = 6000 }
...
Config.seragamwak = {
  ...
  ['arms'] = 22, ['arms_2'] = 0,
  ['decals_0'] = 0, ['decals_2'] = 0,
  ['pants_1'] = 41, ['pants_2'] = 0,
  ['shoes_1'] = 71, ['shoes_2'] = 17,
  ['chain_1'] = 0, ['chain_2'] = 0,
  ['bags_1'] = 21,     ['bags_2'] = 3
		},
		female = {
...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = 1757.84, y = 3341.52, z = 45.88 }, -- ACTION
	...
	Loker = {
		Pos   = { x = 1769.65, y = 3328.61, z = 41.68 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 27,
	},
	...
	--[[Craft = {
		Pos   = { x = 1770.52, y = 3323.69, z = 41.44 }, -- ACTIAN
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},]]
	...
	VehicleSpawnPoint = {
		Pos   = { x = 1776.29, y = 3300.64, z = 41.31 }, -- SPAWN
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = 1758.23, y = 3298.25, z = 40.15 }, -- DELETE
