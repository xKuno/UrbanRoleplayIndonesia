...
function JailLogin()
	...
	exports['mythic_notify']:SendAlert('inform', 'Last time you went to sleep you were jailed, because of that you are now put back!')
...
function UnJail()
	...
	exports['mythic_notify']:SendAlert('inform', 'You are released, stay calm outside! Good LucK!')
end
	...
	Citizen.CreateThread(function()
		...
		while jailTime > 0 do
			...
			jailTime = jailTime - 1
                        ...
                        exports['mythic_notify']:SendAlert('error', 'Waktu Penjara : ' .. jailTime .. ' bulan lagi')
