...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if Distance < 6.0  and not IsPedInAnyVehicle(ped, false) then
            ...
            if #(GetEntityCoords(closestVehicle) + GetEntityForwardVector(closestVehicle) - GetEntityCoords(ped)) > GetDistanceBetweenCoords(GetEntityCoords(closestVehicle) + GetEntityForwardVector(closestVehicle) * -1, GetEntityCoords(ped), true) then
