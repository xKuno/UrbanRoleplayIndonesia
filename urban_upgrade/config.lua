...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = 1755.79, y = 3324.04, z = 42.68},
	...
	ls2 = {
	    Pos   = { x = 1175.05, y = 2639.73, z = 37.75},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls3 = {
		Pos   = { x = 1758.28, y = 3319.49, z = 42.68},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls4 = {
		Pos   = { x = 1760.28, y = 3315.32, z = 42.68},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {4.5, 9.5, 11.5, 17, 19,5}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {2.1, 4.1, 6.1, 8.1, 10.1}
	},
	modTransmission = {
	...
	modSuspension = {
		...
		parent = 'upgrades',
		modType = 15,
		price = {2.3, 4.3, 6.3, 8.3, 10.3}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
		modType = 16,
		price = {13, 16, 19, 21, 26.5}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
