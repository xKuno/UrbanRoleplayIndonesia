...
function setUniform(job, playerPed)
    TriggerEvent('skinchanger:getSkin', function(skin)
      ...
      if skin.sex == 0 then
        ...
        if 'citizen_wear' and 'baju_1' then
        end
      else
        ...
        if 'citizen_wear' and 'baju_2' then
        end
      end
...
function OpenCloakroom2Menu()
	...
	local elements = {
	  ...
	  { label = _U('baju_dokter'),  value = 'baju_dokter'},
	}
	...
	ESX.UI.Menu.Open(
	  ...
	  function(data, menu)
		...
		if
		  data.current.value == 'baju_pasien' or
		  data.current.value == 'baju_dokter'
		then
...
Citizen.CreateThread(function()
	while true do
		...
		if(GetDistanceBetweenCoords(coords, -804.8, -1214.93, 7.34, true) < 1) then
            ESX.ShowHelpNotification('Tekan ~INPUT_CONTEXT~ untuk mengganti pakaian')
...
function OpenPharmacyMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pharmacy', {
		...
		ESX.TriggerServerCallback('esx_ambulancejob:buy', function(bought)
			if bought == true then 
