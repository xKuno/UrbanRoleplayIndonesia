...
function setUniform(job, playerPed)
	TriggerEvent('skinchanger:getSkin', function(skin)
		if skin.sex == 0 then
			...
			elseif job == 'bullet_wear2' then
				SetPedArmour(playerPed, 100)
			elseif job == 'bullet_wear3' then
				SetPedArmour(playerPed, 100)
			elseif job == 'bullet_wear4' then
				SetPedArmour(playerPed, 100)
			elseif job == 'bullet_wear5' then
				SetPedArmour(playerPed, 100)
			end
		else
...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = _U('bullet_wear2'), value = 'bullet_wear2' },
		{ label = _U('bullet_wear3'), value = 'bullet_wear3' },
		{ label = _U('bullet_wear4'), value = 'bullet_wear4' },
		{ label = _U('bullet_wear5'), value = 'bullet_wear5' },
		{ label = _U('gilet_wear'), value = 'gilet_wear' },
	}


	if grade == 'tamtama' then
		table.insert(elements, {label = _U('police_wear'), value = 'tamtama_wear'})
	...
	elseif grade == 'brigadir' then
		table.insert(elements, {label = _U('police_wear'), value = 'brigadir_wear'})
	...
	elseif grade == 'aiptu' then
		table.insert(elements, {label = _U('police_wear'), value = 'aiptu_wear'})
	...
	elseif grade == 'akp' then
		table.insert(elements, {label = _U('police_wear'), value = 'akp_wear'})
	...
	elseif grade == 'kombespol' then
		table.insert(elements, {label = _U('police_wear'), value = 'kombespol_wear'})
	elseif grade == 'boss3' then
		table.insert(elements, {label = _U('police_wear'), value = 'boss3_wear'})
	elseif grade == 'boss2' then
		table.insert(elements, {label = _U('police_wear'), value = 'boss2_wear'})
	...
	if Config.EnableNonFreemodePeds then
		...
		table.insert(elements, {label = _U('swat_wear2'), value = 'swat_wear2'})
		table.insert(elements, {label = _U('latihan_wear'), value = 'latihan_wear'})
		table.insert(elements, {label = _U('latihan_wear4'), value = 'latihan_wear4'})
		table.insert(elements, {label = _U('latihan_wear2'), value = 'latihan_wear2'})
		table.insert(elements, {label = _U('latihan_wear3'), value = 'latihan_wear3'})
		-- table.insert(elements, {label = _U('gilet_wear'), value = 'gilet_wear'})
		-- table.insert(elements, {label = _U('gilet_wear1'), value = 'gilet_wear1'})
	end
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			data.current.value == 'tamtama_wear' or
			data.current.value == 'bripda_wear' or
			data.current.value == 'briptu_wear' or
			data.current.value == 'brigadir_wear' or
			data.current.value == 'bripka_wear' or
			data.current.value == 'aipda_wear' or
			data.current.value == 'aiptu_wear' or
			data.current.value == 'ipda_wear' or
			data.current.value == 'iptu_wear' or
			data.current.value == 'akp_wear' or
			data.current.value == 'kompol_wear' or
			data.current.value == 'akbp_wear' or
			data.current.value == 'kombespol_wear' or
			data.current.value == 'boss3_wear' or
			data.current.value == 'boss2_wear' or
			data.current.value == 'boss_wear' or
			data.current.value == 'bullet_wear' or
			data.current.value == 'swat_wear' or
			data.current.value == 'bullet_wear2' or
			data.current.value == 'bullet_wear3' or
			data.current.value == 'bullet_wear4' or
			data.current.value == 'bullet_wear5' or
			data.current.value == 'latihan_wear' or
			data.current.value == 'latihan_wear2' or
			data.current.value == 'latihan_wear3' or
			data.current.value == 'latihan_wear4' or
...
function OpenArmoryMenu(station)
	...
	if Config.EnableArmoryManagement then
		...
		table.insert(elements, {label = "🔫 Reload Senjata", value = 'reload_weapon'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'citizen_interaction', {
				...
				if closestPlayer ~= -1 and closestDistance <= 3.0 then
					...
					elseif action == 'body_search' then
						...
						TriggerServerEvent('esx_policejob:message', GetPlayerServerId(closestPlayer), 'kamu sedang digeledah')
		...
		elseif data.current.value == 'vehicle_interaction' then
			...
			if DoesEntityExist(vehicle) then
				...
				table.insert(elements, {label = _U('impoundkendaraan'), value = 'impoundkendaraan'})
			...
			ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_interaction', {
				...
				elseif DoesEntityExist(vehicle) then
					...
					elseif action == 'impoundkendaraan' then
					TriggerEvent("HRP:ESX:impundmenueuy")
...
Citizen.CreateThread(function()
	...
	for k,v in pairs(Config.PoliceStations) do
		local blip = AddBlipForCoord(v.Blipcok.Coords)
...
Citizen.CreateThread(function()
	...
	for k,v in pairs(Config.PoliceStations) do
		local blip = AddBlipForCoord(v.Blipsfederal.Coords)
...
Citizen.CreateThread(function()
	...
	for k,v in pairs(Config.PoliceStations) do
		local blip = AddBlipForCoord(v.Blipa.Coords)
...
AddEventHandler('esx_policejob:updateBlip', function(source)
	...
	if PlayerData.job ~= nil and PlayerData.job.name == 'police' then
		ESX.TriggerServerCallback('esx_scoreboard:getConnectedPlayers', function(connectedPlayers, source)
			for k,v in pairs(connectedPlayers) do

				local id 		= GetPlayerFromServerId(v.id)
				local name 		= v.names
				local ruwet = v.dontcry
				local nama 		= '' .. ruwet.. ' - ' .. name
	...
	elseif PlayerData.job ~= nil and PlayerData.job.name == 'pemerintah' then
...
--[[AddEventHandler('esx_ambulancejob:multicharacter', function(spawn)
	IsDead = false
